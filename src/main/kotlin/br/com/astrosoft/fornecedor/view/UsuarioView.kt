...
import br.com.astrosoft.fornecedor.viewmodel.UsuarioViewModel
...
@Route(layout = EngFornecedorLayout::class)
@PageTitle("Usuário")
    ...
    return FormLayout().apply {
      ...
      if (operation in listOf(ADD, READ, DELETE, UPDATE)) {
        ...
        formLayout {
          ...
          checkBox("Pendência") {
            isReadOnly = readOnly
            binder.bind(this, UserSaci::fornecedorPendencia.name)
          }
          checkBox("Concluido") {
            isReadOnly = readOnly
            binder.bind(this, UserSaci::fornecedorConcluido.name)
          }
        }
      }
    }
